...
from planning_utils import get_lat_lon, create_grid, a_star, heuristic, optimize_path, plot_path_on_grid
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        current_local_position = global_to_local(current_global_position, global_home_position) # self.global_home
...
#         grid_start = (315, 445)
        ...
        local_goal_position = global_to_local(goal_lon_lat, global_home_position) # self.global_home
